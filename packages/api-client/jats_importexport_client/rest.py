...
from jats_importexport_client.exceptions import ApiException, ApiValueError
...
class RESTClientObject:
    def __init__(self, configuration) -> None:
        ...
        self.pool_manager: httpx.AsyncClient | None = None
    ...
    def _create_pool_manager(self) -> httpx.AsyncClient:
        ...
        proxy = None
        if self.proxy:
            proxy = httpx.Proxy(url=self.proxy, headers=self.proxy_headers)

        return httpx.AsyncClient(limits=limits, proxy=proxy, verify=self.ssl_context, trust_env=True)
