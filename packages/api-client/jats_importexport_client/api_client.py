...
from jats_importexport_client.configuration import Configuration
from jats_importexport_client.api_response import ApiResponse, T as ApiResponseT
import jats_importexport_client.models
from jats_importexport_client import rest
from jats_importexport_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.0.0a10/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(jats_importexport_client.models, klass)
